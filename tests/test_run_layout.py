...
class SplitStageTests(unittest.TestCase):
    ...
    def test_a_new_attempt_gets_sheet_and_plate_as_separate_stages(self):
        ...
        self.assertIn("05.5-motion-prompt", found)
    ...
    def test_motion_prompt_refinement_sits_between_plate_and_motion(self):
        self.assertLess(STAGE_IDS.index("05-plate"), STAGE_IDS.index("05.5-motion-prompt"))
        self.assertLess(STAGE_IDS.index("05.5-motion-prompt"), STAGE_IDS.index("06-motion"))
